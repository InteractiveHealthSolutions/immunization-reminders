...
<%@ include file="/WEB-INF/template/pagebody.jsp" %>
            ...
            <div class="function-tag">Edit User</div>
<%
boolean perm=false;
try{
perm=UserSessionUtils.hasActiveUserPermission(SystemPermissions.EDIT_USERS_DATA,request);
...
%> 
<%@ include file="/portlets/userEditform.jsp" %>
<%
}else{
%>
<span class="error" style="font-size: medium; color: red">
<c:out value="Sorry you donot have permissions to edit users. Contact your system administrator."></c:out>
</span>
<%
}
%>
