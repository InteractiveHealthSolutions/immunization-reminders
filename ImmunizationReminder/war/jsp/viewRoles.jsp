...
<%@ include file="/WEB-INF/template/pagebody.jsp" %>
            <div class="function-tag">View Roles</div>

<%
boolean perms=false;
try{
perms=UserSessionUtils.hasActiveUserPermission(SystemPermissions.VIEW_ROLES,request);
...
<form id="searchfrm" name="searchfrm" action="viewRoles.htm" method="post">
<div style="overflow: scroll" >
    <table class="searchTable">
             <tr>
                <td>Enter role name</td>
                <td><input type="text" id="roleName" name="roleName" value="${lastSearchRoleName}"/> </td>
                <td></td>
                <td></td>
            </tr>
            <tr>
    ...
    <input type="hidden" id="lastSearchRoleName" name="lastSearchRoleName" value="${lastSearchRoleName}">
    ...
    <input type="hidden" id="totalRows" name="totalRows" value="${totalRows}">
            ...
            %>            	
            	...
            	<%@ include file="/portlets/viewRolegrid.jsp" %>
</div>
</form>
<%
}else{
...
<c:out value="Sorry you donot have permissions to view Roles. Contact your system administrator."></c:out>
</span>
<%
}
%>
