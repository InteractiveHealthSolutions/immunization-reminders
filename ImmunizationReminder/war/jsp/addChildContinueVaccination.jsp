...
<%@ include file="/WEB-INF/template/headersimple.jsp" %>
            <div class="function-tag">Add Child Vaccination details</div>
...
<a href="children.htm"  style="font-size: medium;font-stretch:ultra-expanded;text-shadow: maroon;text-decoration: underline;">Go back , Leave page without adding data..</a>

<%
boolean perm=false;
try{
perm=UserSessionUtils.hasActiveUserPermission(SystemPermissions.ADD_CHILDREN,request);
...
<%@ include file="/portlets/childFlowVaccinationRecordform.jsp" %>
<%
}else{
%>
