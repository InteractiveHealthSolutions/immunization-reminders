...
<input type="hidden" id="page_nav_id" value="_li6">
            <div class="function-tag">Add Vaccines</div>
<div ><a href="viewVaccines.htm">View Existing Vaccines</a></div>
<%
boolean perm=false;
try{
perm=UserSessionUtils.hasActiveUserPermission(SystemPermissions.ADD_VACCINES,request);
...
%> 
<%@ include file="/portlets/vaccineAddform.jsp" %>
<%
}else{
%>
<span class="error" style="font-size: medium; color: red">
<c:out value="Sorry you donot have permissions to add Vaccine. Contact your system administrator."></c:out>
</span>
<%
}
%>
