...
<%@ include file="/WEB-INF/template/pagebody.jsp" %>
            <div class="function-tag">Edit Vaccine</div>
<%
boolean perm=false;
try{
perm=UserSessionUtils.hasActiveUserPermission(SystemPermissions.EDIT_VACCINE,request);
...
%> 
<%@ include file="/portlets/vaccineEditform.jsp" %>
<%
}else{
%>
<span class="error" style="font-size: medium; color: red">
<c:out value="Sorry you donot have permissions to edit vaccines. Contact your system administrator."></c:out>
</span>
<%
}
%>
