...
<%@page import="org.ird.immunizationreminder.service.exception.UserServiceException"%><input type="hidden" id="page_nav_id" value="_li5">
    ...
    <div style="color: red;font-size: small;font-style: italic">${message}</div>
     <input type="hidden" id="action" value="search" name="action" >
            ...
            %>            	
            	...
            	<td width="60%" style="padding: "><a href="#" title="<%=currpagenum-1 %>" onclick="viewNewPage(this);"/>Prev</a> , <c:forEach begin="0" end="<%= total-1 %>" var="i"><a href="#"title="<c:out value="${i}" />" onclick="viewNewPage(this);">${i+1}</a> ,</c:forEach>
            	<a href="#" title="<%=currpagenum+1 %>" onclick="viewNewPage(this);"/>Next</a>
            	</td>
            	</tr>
            	</table>              
