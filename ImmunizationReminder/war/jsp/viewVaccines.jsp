...
<%@ include file="/WEB-INF/template/pagebody.jsp" %>
            ...
            <div class="function-tag">View Vaccines</div>
<div ><a href="addVaccine.htm">Add Vaccines</a></div>
<br>
<%
boolean perms=false;
try{
perms=UserSessionUtils.hasActiveUserPermission(SystemPermissions.VIEW_VACCINES,request);
...
<form id="searchfrm" name="searchfrm" action="viewVaccines.htm" method="post">
<div style="overflow: scroll" >
    <table class="searchTable">
             <tr>
                <td>Enter vaccine name</td>
                <td><input type="text" id="vaccineName" name="vaccineName" value="${lastSearchVaccName}"/> </td>
           		<td></td>
           		<td></td>
           </tr>
            <tr>
    ...
    <input type="hidden" id="lastSearchVaccName" name="lastSearchVaccName" value="${lastSearchVaccName}">
    ...
    <input type="hidden" id="totalRows" name="totalRows" value="${totalRows}">
            ...
            %>            	
            	...
            	<%@ include file="/portlets/viewVaccinegrid.jsp" %>
</div>
</form>
<%
}else{
...
<c:out value="Sorry you donot have permissions to view Vaccines. Contact your system administrator."></c:out>
</span>
<%
}
%>
