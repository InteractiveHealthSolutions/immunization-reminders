...
%>         
    ...
    <tbody class="rows" style="padding: 0;">
   	<c:forEach items="${model.record}" var="rec">
   	 <tr>
            <td><div ><a title="${rec.child.childId}" href="#"  onclick="viewChildDetails(this.title);" >${rec.child.childId}</a></div></td>
<%
...
%> 
			<td>
			<table border="1" width="100%" class="datagrid">
			<thead >
            <tr>
            <th>---</th>
            <th><div>---</div></th>
            ...
            <td><div><a  title="${map.vaccination.vaccinationRecordNum}" href="#"  onclick="viewVaccDet(this);" >Details</a></div></td>           
            ...
            <td><div>${fn:length(map.response)}</div></td>
 			...
 			<tr id="${map.vaccination.vaccinationRecordNum}d${rec.child.childId}p" style="display: none;" >
      		<td></td>
       		<td colspan="11">
            <table border="0" id="${map.vaccination.vaccinationRecordNum}d${rec.child.childId}pdv" class="datagrid" width="100%">
            <tr><td>
            REMINDER<br>
            <table border="1" width="100%" class="datagrid">
            ...
            <tr >
            <td><a  title="${remh.rsmsRecordNum}" href="#"  onclick="viewRemDet(this);" >View</a></td>
